...
public class TestLockManager {
  ...
  public void testThreeSharedDifferentTransactionLockManager() throws InterruptedException {
    final LockManager lockMan = new LockManager();
    Thread thread1 = new Thread(new Runnable() {
      public void run() {
        /*Code to run goes inside here */
    ...
    thread3.start();
    thread3.join(100);
    assertFalse("Transaction 3 Thread should have finished", thread3.isAlive()); //T3 should not be waiting on T1 and T2
    ...
    assertFalse(lockMan.holdsLock("A", 3, LockManager.LockType.SHARED)); //T3 now does not have shared lock
  }
